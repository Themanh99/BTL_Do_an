...
export const TOPSP_REQUEST = 'TOPSP_REQUEST';
export const TOPSP_SUCCESS = 'TOPSP_SUCCESS';
export const TOPSP_FAIL = 'TOPSP_FAIL';

export const CATE_PRO_REQUEST = 'CATE_PRO_REQUEST';
export const CATE_PRO_SUCCESS = 'CATE_PRO_SUCCESS';
export const CATE_PRO_FAIL = 'CATE_PRO_FAIL';
